import 'package:alwali_driver/src/features/auth/auth_repository.dart';
import 'package:alwali_driver/src/features/trip/trip_controller.dart';
...
import 'package:alwali_driver/src/features/notification/home_notifications_page.dart';
import 'package:alwali_driver/src/features/profile/home_account_page.dart';
import 'package:alwali_driver/src/features/trip/home_trips_page.dart';
import 'package:alwali_driver/src/widgets/app_icons_icons.dart';
import 'package:alwali_driver/src/widgets/gnav/gnav.dart';
import 'package:alwali_driver/src/widgets/gnav/gbutton.dart';
...
class _HomeScreenState extends ConsumerState<HomeScreen> {
  ...
  initInfo() {
    ...
    FirebaseMessaging.onMessage.listen((message) async {
      print("===============OnMessage122222222222222222222222================");
      print(
      ...
      String currentLang = sharedPreferences.getString("lang").toString();
      String msg = "";
      print(currentLang);
      if (currentLang == 'en' || currentLang == "null") {
        msg = msgList[0];
      } else {
        msg = msgList[1];
      }
